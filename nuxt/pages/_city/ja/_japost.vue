<template>
  <section class="content" :class="{ ja: displayLanguage === 'ja' }">
    ...
    <div class="japanese-available content-top-full" v-if="content.ja && content.en">
...
export default {
  ...
  async created() {
    ...
    if (!this.content.ja) return this.$router.push('/')
    this.loading = false
  },
  ...
  methods: {
    ...
    setLanguage(language) {
      ...
      if (language === 'en') {
        ...
        this.$router.push(this.publicPath.replace('/ja', ''))
      } else if (language === 'ja') {
        this.$router.push(
          this.path.replace(
            /(\/?[^/]+\/)(.*)/g,
