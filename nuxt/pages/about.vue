<template>
  <section class="content">
    ...
    <template v-if="displayLanguage === 'ja'">
      <h1 class="title"><span class="small">このサイトについて</span></h1>
      <p>
        Traveling Circus of Urbanismは、世界中の都市から様々な街づくりの情報を紹介するサイトです。参考になる街づくりのプロジェクトは日本に限らず海外に沢山あるものの、街づくりの情報サイトは、どうしても１つの地域や都市に限定してしまいがち。そこで、都市、街づくり、建築などのトピックを、グローバルに紹介していくことで、街好きのアーバニスト達が世界中の都市で起こっていることをチェックし、お互いに参考にしあうことが出来るはず。Traveling
        Circus of Urbanismは、そんな想いで活動しています。
      </p>
      <p>
        <strong>Travel(旅)</strong
        >をすることで、場のエッセンスを発見し、今までと異なる視点で都市を経験することが出来ます。また、世界中の各都市は決して独自のものではなく、
        <a href="https://www.unc.edu/courses/2006spring/geog/021/001/massey.pdf"
          >グローバルに関係しあっている</a
        >こともわかります。
      </p>
      <p>
        <strong>A circus(サーカス)</strong
        >は、様々な都市を転々と移動しながら、旅によって得た物語や知見を広めて行きます。
      </p>
      <p>
        <strong>Urbanism(アーバニズム)</strong
        >は、人々の都市における生活様式のことです。
      </p>
      <p>
        Traveling Circus of
        ...
        <div class="person">
          ...
          <span>
            ...
            <div>
              ...
              <a href="www.linkedin.com/in/marikosugita" target="_blank"
                >Full profile</a
              >
            </div>
          </span>
