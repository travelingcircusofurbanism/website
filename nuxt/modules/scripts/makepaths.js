...
const pathToStaticPosts =
  process.cwd() + '/nuxt/static/posts/'
...
export default function() {
  ...
  postDirList
    ...
    .forEach((dirToDelete) => {
      log(
        'magenta',
        ' Deleting unnused dir "' + dirToDelete + '"',
      )
      wipeAndDeleteDirRecursively(
        pathToStaticPosts + dirToDelete,
      )
    })
