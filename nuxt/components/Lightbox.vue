<template>
  ...
  >
    <div
      ...
      :style="{
        'background-image': `url('${displayImageSrc}')`,
      }"
      class="lightboximage"
    ></div>
...
export default {
  ...
  computed: {
    src() {
      return this.$store.state.lightboxSrc
    },
    isMobile() {
...
.loader {
  ...
  border-right: $width solid rgba(#eee, 0.8);
  border-left: $width solid rgba(#eee, 0.8);
