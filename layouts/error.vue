  ...
  <no-ssr>
    <div class="error-center">
      ...
      <div class="centered">
        ...
        <EmbeddedPostPreview
          v-bind="calloutPosts[0]"
        />
        <EmbeddedPostPreview
          v-bind="calloutPosts[1]"
        />
        <EmbeddedPostPreview
          v-bind="calloutPosts[2]"
        />
      </div>
    </div>
  </no-ssr>
